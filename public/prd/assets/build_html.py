# -*- coding: utf-8 -*-
"""把 PRD 的 Markdown 转成带侧边导航的单页 HTML（离线可读）。"""
import re
import os
import html
import markdown
...
SRC = os.path.join(BASE, "校园二手交易智能系统_产品需求规格说明书.md")
CSS = os.path.join(BASE, "assets", "prd_style.css")
OUT = os.path.join(BASE, "校园二手交易智能系统_产品需求规格说明书.html")
...
<title>校园二手交易智能系统 · 产品需求规格说明书</title>
<style>
%s
</style>
</head>
...
%s
  ...
  <div class="main">
    <div class="topbar">
      ...
      <span class="meta">48 条需求 · V1.0 交付 35 条</span>
    </div>
    <article class="doc">
%s
    </article>
...
(function(){
  ...
  links.forEach(function(a, i){
    a.addEventListener('click', function(e){
      ...
      /* 加锁，防止 smooth 动画过程中 onScroll 把高亮抢走 */
      scrollLock = true;
      clearTimeout(lockTimer);

      target.scrollIntoView({behavior:'smooth', block:'start'});

      /* smooth 动画通常 400~600ms，800ms 后解锁足够覆盖各种情况 */
